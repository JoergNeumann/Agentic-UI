...
string serverUrl = Environment.GetEnvironmentVariable("AGUI_SERVER_URL") ?? "http://localhost:5253";// http://localhost:8888";

Console.WriteLine($"Connecting to AG-UI server at: {serverUrl}\n");
Console.WriteLine($"Beispiel-Prompt: \"Kannst Du mir Restaurants in Hamburg empfehlen?\"\n");
